                        ...
                        <div class="card-body col-lg-6">
                            <div class="form-group">
                                <div class="form-group accordion">
                                    ...
                                    <input id="name" name="name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $product->name }}">
                                    <p class="text-danger">{{ $errors->first('name') }}</p>
                                </div>

                                <div class="form-group accordion">
                                    <label for="code" class="control-label mb-1">Code<span class="badge">*</span></label>
                                    <input id="code" name="code" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{ $product->code }}">
                                    ...
                                    <label for="category_id" class="control-label mb-1">Category<span class="badge">*</span></label>
                                        <select name="category_id" id="category_id" class="form-control" required>
                                            @foreach ($category as $value)
                                                <option value="{{$value->id}}" @if($value->id == $product->category_id) selected @endif >{{ $value->category_name }}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="card-body col-lg-6">
                            <div class="form-group">
                                <div class="form-group accordion">
                                    ...
                                    <input id="price" name="price" type="number" class="form-control" aria-required="true" aria-invalid="false" value="{{ $product->price }}">
                                    <p class="text-danger">{{ $errors->first('price') }}</p>
                                </div>
                                <div class="form-group accordion">
                                    <label for="quantity" class="control-label mb-1">Quantity<span class="badge">*</span></label>
                                    <input id="quantity" name="quantity" type="number" class="form-control" aria-required="true" aria-invalid="false" value="{{ $product->quantity }}">
                                ...
                                <div class="form-group accordion">
                                    ...
                                    <img src="{{ asset('uploads/'.$product->image) }}" alt="" width="100" height="100">
